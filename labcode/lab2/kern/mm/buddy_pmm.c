...
struct Page_bt {
    ...
    char vacancy[sizeof(list_entry_t) - 2 * sizeof(binary_tree_node_t)];  //��ն��룬�Ƚϰ�ȫ
};
...
buddy_check(void) {
    ...
    /*check 2: ����2^0,2^1 ... 2^(log2n-1),�ٷ���1��������ɹ����ٷ���1��������ʧ��*/
    ...
    cprintf("grading: %d / %d points\n",score, sumscore);
    #endif
    /*check 3: ����2^(log2n-1),2^(log2n-2) ... 2^0,�ٷ���1��������ɹ����ٷ���1��������ʧ��*/
